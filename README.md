...
- The minimum amount of clues provided the constraint above is 17, as mathematically proven by [McGuire et al](https://arxiv.org/abs/1201.0749). (Difficulty 64 empty cells)
